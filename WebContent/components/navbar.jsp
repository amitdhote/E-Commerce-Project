    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="images/phonee.png" style="width:27px;" alt="img">+91 7354031388 / +91 8871230830<br>
                <img src="images/emaill.png" style="width:29px;" alt="img">amitd.nit.mca@@gmail.com
            </b>
        </p>
        </div>
      </div>
